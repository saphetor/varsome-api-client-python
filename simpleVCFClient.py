...
def main(argv):
	...
	for record in vcf_reader:
		...
		# If we want to perform an individual lookup for each variant (which is not recommended for performance issues), execute the lookup now and process the outcome
		if (not do_batch):
			...
			# If we have reached the limit of variants in our request, execute it
