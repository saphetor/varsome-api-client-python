...
class ExAC(models.Base):
    ...
    ac_sas = fields.IntField(
        help_text="Allele Count South Asian", required=False, nullable=True
    )
    ...
    an_sas = fields.IntField(
        help_text="Allele Number South Asian", required=False, nullable=True
    )
    ...
    hom_sas = fields.IntField(
        help_text="Number of Homozygotes South Asian", required=False, nullable=True
    )
    ...
    hemi_afr = fields.IntField(
        help_text="Number of Hemizygotes African", required=False, nullable=True
    )
    hemi_amr = fields.IntField(
        help_text="Number of Hemizygotes American", required=False, nullable=True
    )
    ...
    hemi_eas = fields.IntField(
        help_text="Number of Hemizygotes East Asian", required=False, nullable=True
    )
    ...
    hemi_oth = fields.IntField(
        help_text="Number of Hemizygotes Other", required=False, nullable=True
    )
    hemi_sas = fields.IntField(
        help_text="Number of Hemizygotes South Asian", required=False, nullable=True
    )
    ...
    af_sas = fields.FloatField(
        help_text="Allele Frequency South Asian", required=False, nullable=True
    )
