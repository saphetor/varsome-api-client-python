...
class Cosmic(models.Base):
    ...
    primary_site = fields.ListField(
        items_types=(str,), help_text="Primary site", required=False, nullable=True
    )
    pub_med_references = fields.ListField(
        items_types=(int,), help_text="PUBMED References", required=False, nullable=True
    )


class CosmicLicensedDrugEntry(models.Base):
    drug_name = fields.StringField(help_text="Drug name", required=False, nullable=True)
    somatic_status = fields.StringField(
        help_text="Somatic status", required=False, nullable=True
    )
    ...
    transcript = fields.StringField(
        help_text="Transcript", required=False, nullable=True
    )
    census_gene = fields.StringField(
        help_text="Census gene", required=False, nullable=True
    )
    pub_med_references = fields.ListField(
        items_types=(int,), help_text="PUBMED References", required=False, nullable=True
    )
    histology_freq = fields.ListField(
        items_types=(float,),
        help_text="Histology frequency",
        required=False,
        nullable=True,
    )
    tissue_freq = fields.ListField(
        items_types=(float,),
...
class CosmicLicensedDetails(models.Base):
    entry_type = fields.StringField(
        help_text="Entry type", required=False, nullable=True
    )
    cosmic_id = fields.ListField(
        items_types=(
            str,
            dict,
        ),
    ...
    genome_wide_screen_freq = fields.ListField(
        items_types=(int, str, float),
        help_text="Histology frequency",
        required=False,
        nullable=True,
    )
    loh_freq = fields.ListField(
        items_types=(int, str, float),
        help_text="LOH frequency",
        required=False,
        nullable=True,
    )
    age_freq = fields.ListField(
        items_types=(int, str, float),
        help_text="Age frequency",
        required=False,
        nullable=True,
    )
    zygosity_freq = fields.ListField(
        items_types=(int, str, float),
    ...
    primary_site_freq = fields.ListField(
        items_types=(int, str, float),
        help_text="Primary site frequency",
        required=False,
        nullable=True,
    )
    description = fields.ListField(
        items_types=(str,), help_text="Description", required=False, nullable=True
    )
    accession_number = fields.ListField(
        items_types=(str,), help_text="Accession number", required=False, nullable=True
    )
    fathmm_prediction = fields.StringField(
        help_text="FATHMM prediction", required=False, nullable=True
    )
    fathmm_score = fields.FloatField(
        help_text="FATHMM score", required=False, nullable=True
    )
    num_entries = fields.IntField(
        help_text="Number of entries", required=False, nullable=True
    )
    num_samples = fields.IntField(
        help_text="Number of samples", required=False, nullable=True
    )
    gene = fields.ListField(
        items_types=(str,), help_text="Gene", required=False, nullable=True
    )
    ...
    fathmm_mkl_non_coding_groups = fields.StringField(
        help_text="FATHMM_MKL non coding groups", required=False, nullable=True
    )
    whole_exome_freq = fields.ListField(
        items_types=(
            str,
            int,
            float,
    ...
    resistance_mutation = fields.ListField(
        items_types=(str,),
        help_text="Resistance mutation",
        required=False,
        nullable=True,
    )
    drug_entries = fields.ListField(
        items_types=(CosmicLicensedDrugEntry,),
...
class ComsicPublicDetails(models.Base):
    ...
    is_consistent = fields.BoolField(
        help_text="Cosmic ID is consistent across databases"
    )
...
class CosmicPublic(models.Base):
    ...
    items = fields.ListField(
        items_types=(ComsicPublicDetails,),
        help_text="Details",
        required=False,
        nullable=True,
    )
