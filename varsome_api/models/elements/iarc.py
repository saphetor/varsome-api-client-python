...
class TP53GermlineDetails(models.Base):
    age_at_diagnosis = fields.IntField(
        help_text="Age at diagnosis", required=False, nullable=True
    )
    ...
    familycase = fields.StringField(
        help_text="Family case", required=False, nullable=True
    )
    familycase_group = fields.StringField(
        help_text="Family case group", required=False, nullable=True
    )
    family_code = fields.StringField(
        help_text="Family code", required=False, nullable=True
    )
    generation = fields.StringField(
        help_text="Generation", required=False, nullable=True
    )
    morphology = fields.StringField(
        help_text="Morphology", required=False, nullable=True
    )
    sex = fields.StringField(help_text="Sex", required=False, nullable=True)
    topography = fields.StringField(
        help_text="Topography", required=False, nullable=True
    )
...
class TP53SomaticDetails(models.Base):
    ...
    sample_source = fields.StringField(
        help_text="Sample source", required=False, nullable=True
    )
    stage = fields.StringField(help_text="Stage", required=False, nullable=True)
    structural_motif = fields.StringField(
        help_text="Structural Motif", required=False, nullable=True
    )
    topography = fields.StringField(
        help_text="Topography", required=False, nullable=True
    )
